...
- Graphics mode (WebSocket only): `HGR`, `TEXT`, `PSET`, `LINE`, `CIRCLE` with 640×480 resolution and 16 colors
...
- [examples/graphics.bas](examples/graphics.bas) - Graphics demo using `HGR`, `PSET`, `LINE`, `CIRCLE`, and `TEXT` to draw shapes and pixels on a 640×480 canvas (WebSocket only).
