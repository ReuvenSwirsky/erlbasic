...
- Expressions support integer/float literals, quoted strings, variable lookup, arithmetic operators, common BASIC math functions, and string functions (`LEFT$`, `RIGHT$`, `MID$`, `LEN`, `DATE$`, `TIME$`).
